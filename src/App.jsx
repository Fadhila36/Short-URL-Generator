...
function App() {
  ...
  return (
    <div>
      <div>
        {copied ? (
          <div className="px-5 py-3 flex bg-indigo-100 items-center text-indigo-600 absolute w-full top-0 left-0 right-0 z-10">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-4 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 text-base"
              ...
              <button
                ...
                className={
                  disable
                    ...
                    : 'group w-full flex justify-center py-4 px-5 border border-transparent text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                }
              >
                {loading ? (
                  <img
